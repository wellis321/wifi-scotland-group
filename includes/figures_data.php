...
/**
 * Every statistic used across the site, grouped by topic — the single source of
 * truth for both figures.php (the fact-check log) and corrections.php (which
 * automatically lists every entry whose note starts with "Corrected"). To log a
 * correction, just update the relevant entry's 'note' field here — corrections.php
 * picks it up with no separate step.
 */
/*
 ...
 */
function load_figures(): array
{
    return [
    'Social tariffs & broadband affordability' => [
        [
            'claim'   => '1 in 12 qualifying UK households (≈532,000 of 6.2m) use a social tariff',
            'used_on' => [['label' => 'Home', 'href' => '/'], ['label' => 'Why it matters', 'href' => '/why-it-matters'], ['label' => 'Get help', 'href' => '/get-help'], ['label' => 'Who is acting?', 'href' => '/accountability'], ['label' => 'News', 'href' => '/news']],
            ...
            'note'    => '8.6% is the precise figure; "1 in 12" is a fair rounding. A news article previously said "4-8 million" eligible instead of 6.2m — that range conflated an older, smaller Universal Credit caseload figure with a separate, broader "affordability hardship" statistic; corrected to 6.2m for consistency with the rest of the site.',
        ],
        [
    ...
    'Scottish broadband coverage (R100)' => [
        ...
        [
            'claim'   => '76% of connected businesses report increased productivity from R100; around two-thirds of residents feel more connected',
            'used_on' => [['label' => 'News', 'href' => '/news']],
            'source'  => 'Scottish Government — R100 Interim Evaluation',
            'url'     => 'https://www.gov.scot/publications/r100-interim-evaluation/',
            'date'    => 'Nov 2025',
            'note'    => 'Confirmed against the actual evaluation report — these are real, correctly-cited figures.',
        ],
        [
            'claim'   => 'An estimated 9% of Scottish households — around 490,000 people — have no internet connection at all',
            'used_on' => [['label' => 'News', 'href' => '/news']],
            'source'  => 'Scottish Household Survey 2023; Audit Scotland, Tackling Digital Exclusion',
        ...
        [
            ...
            'used_on' => [['label' => 'News', 'href' => '/news']],
            'source'  => 'UK Government / Building Digital UK',
            'url'     => 'https://www.gov.uk/government/news/scotlands-most-remote-towns-and-villages-get-huge-broadband-upgrade-as-uk-government-vows-to-end-digital-exclusion-plight',
            'date'    => 'May 2025',
    ...
    'Scotland\'s £200m digital inclusion pledge' => [
        [
            'claim'   => 'The 2021 Programme for Government pledged £200 million to get up to 300,000 households online by the end of that Parliament (2026)',
            'used_on' => [['label' => 'News', 'href' => '/news'], ['label' => 'Write to your councillor', 'href' => '/write-to-councillor']],
            'source'  => 'Scottish Government — Programme for Government 2021-22',
            'url'     => 'https://www.gov.scot/publications/fairer-greener-scotland-programme-government-2021-22/pages/7/',
            'date'    => 'Sep 2021',
            'note'    => 'Confirmed against the exact primary-source wording. A smaller 2023 follow-on plan (£2.4m-£9.8m, targeting 4,000-16,000 people) also underdelivered — worth mentioning for completeness, though it doesn\'t change the core claim.',
        ],
        [
            'claim'   => 'The only Scottish Government digital-exclusion funding in the 2025-26 budget is around £764,000, passed through from the UK Government\'s Digital Inclusion Innovation Fund as a Barnett consequential',
            'used_on' => [['label' => 'News', 'href' => '/news']],
            'source'  => 'funding.scot — Digital Inclusion Innovation Fund',
            'url'     => 'https://funding.scot/funds/a0RP1000007nYnhMAE/digital-inclusion-innovation-fund',
            'date'    => '2025-26',
            'note'    => 'Confirmed: £764,020 split between a CivTech challenge (£321,692) and the Connecting Scotland Digital Inclusion Fund (£442,327).',
        ],
        [
            'claim'   => 'Connecting Scotland was funded at £50m at its pandemic peak in 2020',
            'used_on' => [['label' => 'News', 'href' => '/news'], ['label' => 'Why WIRES exists', 'href' => '/landscape']],
            'source'  => 'Scottish Government — Connecting Scotland: phase 1 evaluation',
            'url'     => 'https://www.gov.scot/publications/connecting-scotland-phase-1-evaluation/',
            'date'    => 'May 2020-Dec 2021',
            'note'    => 'Confirmed.',
        ],
        [
            'claim'   => '"No leadership, no momentum: Scottish Government has failed to act on digital exclusion" (Third Force News)',
            'used_on' => [['label' => 'Who is acting?', 'href' => '/accountability'], ['label' => 'Resources', 'href' => '/resources']],
    ...
    'Get Help scheme details' => [
        ...
        [
            ...
            'used_on' => [['label' => 'Get help', 'href' => '/get-help']],
            'source'  => 'GOV.UK — find your nearest Jobcentre Plus',
            'url'     => 'https://www.gov.uk/contact-jobcentre-plus',
            'date'    => 'Checked Jul 2026',
            'note'    => 'Removed a previously-published "Monday to Friday, 10am-3pm" digital-mentor schedule — that specific claim traced only to a single 2017 local council press release about three branches, not a current national standard. Support hours genuinely vary by branch.',
        ],
        [
            'claim'   => 'TalkTalk has offered free superfast broadband for six months to DWP benefit claimants, referred by a work coach',
            'used_on' => [['label' => 'Get help', 'href' => '/get-help']],
            'source'  => 'GOV.UK — low-cost broadband and mobile tariffs for benefit claimants',
            'url'     => 'https://www.gov.uk/government/news/low-cost-broadband-and-mobile-phone-tariffs',
            'date'    => 'Checked Jul 2026',
            'note'    => 'Whether this specific scheme is still running as of mid-2026 is disputed between sources — some suggest it paused in 2025. Softened the copy to reflect that uncertainty rather than asserting it confidently.',
        ],
    ],
    ];
}
