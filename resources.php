...
<div class="section">
    <div class="wrap">
        ...
        <ol class="ref-list">
            ...
            <li><a href="https://www.scotnet.co.uk/rural-broadband/wester-ross"<?= external_link_attrs('https://www.scotnet.co.uk/rural-broadband/wester-ross') ?>>Highland Community Broadband</a> — the volunteer-run CIC served Ullapool 2017–2026 before rising operational costs made continuing unviable; it sold the network to Scotnet in May 2026, who have kept it running and upgraded it (now Wester Ross Broadband). A case study in the volunteer-run model's fragility, and in a network changing hands rather than going dark.</li>
