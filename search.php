    ...
    <div class="wrap" style="max-width:760px">
        ...
        <?php elseif ($q === ''): ?>
            <div style="margin-top:2rem">
                ...
                <p style="color:var(--muted)">Looking for something specific? Try: <a href="/get-help">help getting online</a>, <a href="/why-it-matters">why it matters</a>, <a href="/scotland">Scottish policy</a>, or <a href="/news">news</a>.</p>
            </div>
        <?php endif; ?>
