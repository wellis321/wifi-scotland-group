...
// includes/campaign-templates/councillor-public-statement.php — shared with
// councillor-statements.php, which renders the same template publicly. reply_by_date()
// lives in includes/bootstrap.php, shared with bin/send-council-ceo-campaign.php.
