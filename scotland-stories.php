    ...
    <div class="wrap">
        <?php if (!$stories): ?>
            <div class="callout prose">
                <p><strong>This list is temporarily unavailable.</strong> Please try again later or <a href="/contact">get in touch</a> if the problem persists.</p>
            </div>
        <?php else: ?>
            <p class="section-intro">
                ...
                For editorials and updates published here, see <a href="/news">News</a>.
            </p>
        ...
        <div class="callout prose scotland-stories-footer-callout">
            <p>Policy context and official programme hubs remain on <a href="/scotland">Scotland: government &amp; councils</a>. Suggest additions or corrections via <a href="/contact">Contact</a>.</p>
        </div>
    </div>
</div>
